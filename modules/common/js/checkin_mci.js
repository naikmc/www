...
$(document).on("click",'.sectionDefaultstyle nav.tabs li[role=radio] a.navigation', function() {
...
$(document).on("click",".sectionDefaultstyle *[role=option]", function() {
...
/* *************************************************************************** */
$(document).on("click",".sectionDefaultstyle a.add-passbook", function() {
  if ($('.secondary.add-passbook').hasClass('disabled')) {
    return false;
  }
  $("#dialog-passbook, .popupBGmask").show();
});
...
//  checkBoxDAG.on("change",function() {
...
$(document).on("change",identifyElement.selector, function() {
...
$(document).on("click",'.sectionDefaultstyle button.services', function() {
...
var toggle = false;
$(document).on("click",'.sectionDefaultstyle ul#input-radio-switch', function() {
  if (toggle == false) {
...
$(document).on("click",'.sectionDefaultstyle ul.getPassbook .email', function() {
...
$(document).on("click",'.sectionDefaultstyle ul.getPassbook .sms', function() {
...
$(document).on("click",'.sectionDefaultstyle .popup.input-panel .buttons .validation.cancel', function() {
...
$(document).on("click",".sectionDefaultstyle a.add-passbook", function() {
  ...
  jQuery(".popupBGmask").removeClass("loading");
  $("#dialog-passbook, .popupBGmask").show();
});
