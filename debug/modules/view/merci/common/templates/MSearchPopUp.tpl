{Template{
  $classpath: 'modules.view.merci.common.templates.MSearchPopUp',
  ...
  {macro loadContent()}
    {if printUI == true}
      ...
      {/if}
      <header>
          <h1>Search<span class="tabletPanelClose" {on click {fn:'closePopUTpl',scope: this}/}>close</span></h1>
        </header>

      <section class="search">

        <form id="searchFormPopUp" name="searchFormPopUp">
