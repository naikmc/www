{Template {
$classpath:'modules.view.merci.segments.servicing.subModules.checkin.templates.pages.DangerousGoods',
$macrolibs : {
...
$hasScript: true
  ...
  {macro main()}
     ...
     {var label = this.moduleCtrl.getModuleData().checkIn.MDangerousGoods_A.labels /}
